...
public plugin_precache()
{
    ...
    g_hclass_jump = zp_register_class(CLASS_HUMAN, hclass_name, hclass_info, hclass_model, "default", 5, 0, ADMIN_LEVEL_F, hclass_health, 60, hclass_speed, hclass_gravity, hclass_knockback);
}
/*
