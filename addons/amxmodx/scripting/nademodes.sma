...
public plugin_init()
{
	...
	register_message(g_msgTextMsg,  "fith_text")
...
public changemode(id, NadeRace:NADE_TYPE)
{
	...
	switch (mode[id][NADE_TYPE])
	{
		case NADE_NORMAL:
		{
			client_print_center(id, print_center, "Mode - Normal")
		}
		
		case NADE_PROXIMITY:
		{
			client_print_center(id, print_center, "Mode - Proximity")
		}
		
		case NADE_IMPACT:
		{
			client_print_center(id, print_center, "Mode - Impact")
		}
		
		case NADE_TRIP:
		{
			client_print_center(id, print_center, "Mode - Trip laser")
		}
		
		case NADE_MOTION:
		{
			client_print_center(id, print_center, "Mode - Motion sensor")
		}
		
		case NADE_SATCHEL:
		{
			client_print_center(id, print_center, "Mode - Satchel charge")
		}
		
		case NADE_HOMING:
		{
			client_print_center(id, print_center, "Mode - Homing")
		}
