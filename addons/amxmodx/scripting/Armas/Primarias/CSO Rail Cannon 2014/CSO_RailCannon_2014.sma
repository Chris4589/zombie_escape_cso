...
// Main Vars
new g_Had_RC, g_OldWeapon[33], g_WeaponState[33], g_item
new g_MsgWeaponList, g_MsgCurWeapon, g_MsgAmmoX, g_Event_RC, g_SmokePuff_Id, m_spriteTexture
...
public fw_Item_AddToPlayer_Post(ent, id)
{
	...
	write_string(Get_BitVar(g_Had_RC, id) ? "weapon_xm1014" : weapon_railcannon)
	write_byte(5)
	write_byte(32)
	write_byte(-1)
	write_byte(-1)
