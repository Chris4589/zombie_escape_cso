...
#define V_MODEL "models/v_m60craft.mdl"
#define P_MODEL "models/p_m60craft.mdl"
#define W_MODEL "models/w_m60craft.mdl"
...
#define FIRE_SOUND "weapons/m60-1.wav"

new const ExtraSounds[4][] =
{
	"weapons/m60craft_clipin1.wav",
	"weapons/m60craft_clipin2.wav",
	"weapons/m60craft_clipin3.wav",
	"weapons/m60craft_clipout.wav"
}
...
public plugin_init()
{
	...
	g_Weapon = zp_arma("Maverick M60", 20, 3, PRIMARIA, ADMIN_ALL, "");		
...
public dar_arma(id, item)
{
	...
	if(item == g_Weapon) Get_Weapon(id)
}
