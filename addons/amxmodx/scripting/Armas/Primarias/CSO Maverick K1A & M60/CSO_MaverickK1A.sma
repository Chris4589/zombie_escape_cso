...
#define PLUGIN "[CSO] Maverick K1A"
#define VERSION "1.0"
#define AUTHOR "Dias"

#define V_MODEL "models/v_k1acraft.mdl"
#define P_MODEL "models/p_k1acraft.mdl"
#define W_MODEL "models/w_k1acraft.mdl"

#define CSW_BASEDON CSW_MP5NAVY
#define weapon_basedon "weapon_mp5n"
...
#define SHOOT_ANIM random_num(4, 6)
#define DRAW_ANIM 3
...
#define FIRE_SOUND "weapons/k1acraft-1.wav"

new const ExtraSounds[5][] =
{
	"weapons/k1acraft_boltpull.wav",
	"weapons/k1acraft_clipin.wav",
	"weapons/k1acraft_clipout.wav",
	"weapons/k1acraft_clipout2.wav",
	"weapons/k1acraft_draw.wav"
}
...
public plugin_init()
{
	...
	g_item = zp_arma("Maverick K1A", 26, 0, PRIMARIA, ADMIN_ADMIN, "");		
