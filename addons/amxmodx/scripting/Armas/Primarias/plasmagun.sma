...
public plugin_init()
{
	...
	cvar_dmg_plasmagun = register_cvar("zp_plasmagun_dmg", "90")
	...
	g_item = zp_arma( "PlasmaGun", 0, 22, ESPECIALES, ADMIN_IMMUNITY, "ADMIN GOLD" );
}
...
public event_round_start() {
	for (new id; id <= 32; id++) g_has_plasmagun[id] = false;
}
