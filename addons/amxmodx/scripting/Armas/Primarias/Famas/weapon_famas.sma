...
#define MODEL_V "models/zp/v_zp_famas.mdl"
#define MODEL_P "models/zp/p_zp_famas.mdl"

#define NOMBRE "Famas"
#define CATEGORIA PRIMARIA
#define CSW CSW_FAMAS
#define weapon "weapon_famas"
...
public plugin_init()
{
	...
	g_item = zp_arma(NOMBRE, 2, 0, CATEGORIA, ADMIN_ALL, "");
