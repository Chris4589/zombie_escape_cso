...
new g_Event_Janus3, g_Msg_WeaponList, g_SmokePuff_SprId, g_RifleShell_Id, g_item
...
public plugin_init()
{
	...
	g_item = zp_arma("Janus 3", 0, 2, PRIMARIA, ADMIN_ALL, "");
	
	g_Msg_WeaponList = get_user_msgid("WeaponList")
	//register_clcmd("admin_get_janus3", "Get_Janus3")
	register_clcmd("weapon_ump45", "Hook_Weapon")
}
...
public fw_SetModel(entity, model[])
{
	...
	if(equal(model, JANUS3_OLDMODEL))
	{
		...
		if(Get_BitVar(g_Had_Janus3, iOwner))
		{
			...
			engfunc(EngFunc_SetModel, entity, JANUS3_OLDMODEL)
...
public fw_Item_AddToPlayer_Post(Ent, id)
{
	...
	write_string(Get_BitVar(g_Had_Janus3, id) ? "weapon_ump45" : "weapon_ump45")
