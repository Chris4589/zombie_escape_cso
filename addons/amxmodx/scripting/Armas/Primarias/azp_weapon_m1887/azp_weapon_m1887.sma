...
public plugin_init()
{
	...
	cvar_dmg_m1887 = register_cvar("zp_m1887_dmg", "1.8")
	...
	g_itemid_m1887 = zp_arma("Winchester M1887", 17, 0, PRIMARIA, ADMIN_ALL, "");
...
public fw_TraceAttack_player(victim, attacker, Float:damage, Float:direction[3], tracehandle, damage_type){
	...
	if(g_currentweapon != CSW_M3) return HAM_IGNORED
	
	if(!g_has_m1887[attacker]) return HAM_IGNORED
	...
	xs_vec_mul_scalar(direction, 4.5, direction)
