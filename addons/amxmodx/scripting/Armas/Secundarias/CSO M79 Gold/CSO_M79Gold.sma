...
#define DAMAGE 300 // 280 for Zombies
#define AMMO 999

#define RELOAD_TIME 3.0
#define GRENADE_RADIUS 120.0

#define V_MODEL "models/m79/v_m79g.mdl"
#define P_MODEL "models/m79/p_m79g.mdl"
//#define W_MODEL "models/w_m79g.mdl"
#define S_MODEL "models/m79/s_oicw.mdl"
...
new g_HamBot, g_MsgCurWeapon, g_MsgAmmoX, g_SmokePuff_SprId, g_Trail_SprId, g_Exp_SprId, g_SmokeSprId, g_item
...
public plugin_init()
{
	...
	g_item = zp_arma("M79 GOLD", 0,1, SECUNDARIA, ADMIN_ALL, "")
...
public plugin_natives()     register_native("m79g", "Get_M79G", 1)