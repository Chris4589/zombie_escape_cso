...
new const wp_model[2][] = {
	"models/mauser/v_mauserc96.mdl",
	"models/mauser/p_mauserc96.mdl"
}
...
public plugin_init()
{
	...
	g_item = zp_arma("Mauser", 14, 0, SECUNDARIA, ADMIN_ALL, "");
...
public fw_PlaybackEvent(flags, invoker, eventid, Float:delay, Float:origin[3], Float:angles[3], Float:fparam1, Float:fparam2, iParam1, iParam2, bParam1, bParam2)
{
	...
	emit_sound(invoker, CHAN_WEAPON, wp_sound[0], 1.0, ATTN_NORM, 0, PITCH_NORM)
