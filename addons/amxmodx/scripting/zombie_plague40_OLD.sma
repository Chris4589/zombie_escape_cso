...
new const LogrosGeneral[][eLogros] = {
	{ "Mata 150 Zombies", 150, 500 },
	{ "Mata 50 servivors", 50, 100 }
};

new const LogrosZombies[][eLogros] = {
	{ "Mata 150 Zombies", 150, 500 },
	{ "Mata 50 servivors", 50, 100 }
};

new const LogrosHumans[][eLogros] = {
	{ "Mata 150 Zombies", 150, 500 },
	{ "Mata 50 servivors", 50, 100 }
};
...
new g_iKill[33][2];
new g_iLogro[33][2];
new LogroServer[33][2]; //deben estar en 1 ambos para poder resetear las misiones
...
public plugin_precache()
{
	...
	register_plugin("Zombie Escape Evolution", PLUGIN_VERSION, "MeRcyLeZZ")
...
public menu_game(id, key)
{
	switch (key)
	{
		...
		case 7:
		{
			show_motd( id, "https://www.svlmexico.com/zombie_escape/top_escapes.php", "TOP EVENTO HALLOWEEN");
...
public top_handler(id, menu, item)
{
	...
	switch(item)
	{
		case 0: show_motd(id, "https://www.svlmexico.com/zombie_escape/top15.php", "Top15");
		case 1: show_motd(id, "https://www.svlmexico.com/zombie_escape/topaps.php", "Top APS");
		case 2:
		{
			new szMapname[64], url[120];
			get_mapname(szMapname, 63);
			formatex(url, 119, "https://www.svlmexico.com/zombie_escape/toprecords.php?mapname=%s", szMapname);
...
{
	if(active_button() || g_iExplote[id])
		return;
