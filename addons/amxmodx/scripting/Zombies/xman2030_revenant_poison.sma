...
new const ball_model[] = "models/YouTuber/w_poisonball_poison.mdl"
new const ball_firespritemdl[] = "sprites/YouTuber/zbs_bossheal.spr"
new const ball_spriteexplodemdl[] = "sprites/YouTuber/restore_health.spr"

new const zclass_name[] = { "Revenant Poison" } // name
new const zclass_info[] = { "Poison" } // description
new const zclass_model[] = { "b7_15471_rev_poison" } // model
new const zclass_clawmodel[] = { "v_b7_15471_rev_poison.mdl" } // claw model
const zclass_health = 7000 // health
...
public plugin_init()
{
	...
	cvar_dragondelay = register_cvar("zp_classdragon_delay","20")
	cvar_dragondmg = register_cvar("zp_classdragonball_dmg","100.0")
...
public plugin_precache()
{
	...
	sprFlame = precache_model("sprites/YouTuber/zbs_bossheal.spr")
	sprSmoke = precache_model("sprites/YouTuber/black_smoke3.spr")

	g_poison = zp_register_class(CLASS_ZOMBIE, zclass_name, zclass_info, zclass_model, zclass_clawmodel, 
	...
	index = precache_model("models/player/b7_15471_rev_poison/b7_15471_rev_poison.mdl")
...
{ 
	...
	{ 
		...
		{ 
	    		...
	    		client_print(id, print_chat, "Данный класс только для Анубис'а")
        	}     
    	}	 
} 
