...
public plugin_precache()
{
	...
	zp_register_class(CLASS_ZOMBIE, zclass2_name, zclass2_info, zclass2_model, zclass2_clawmodel, 4, 0, ADMIN_ALL, zclass2_health, 0, zclass2_speed, zclass2_gravity, zclass2_knockback)
	zp_register_class(CLASS_ZOMBIE, zclass3_name, zclass3_info, zclass3_model, zclass3_clawmodel, 6, 0, ADMIN_ALL, zclass3_health, 0, zclass3_speed, zclass3_gravity, zclass3_knockback)
	zp_register_class(CLASS_ZOMBIE, zclass4_name, zclass4_info, zclass4_model, zclass4_clawmodel, 8, 0, ADMIN_ALL, zclass4_health, 0, zclass4_speed, zclass4_gravity, zclass4_knockback)
	g_zclass_leech = zp_register_class(CLASS_ZOMBIE, zclass5_name, zclass5_info, zclass5_model, zclass5_clawmodel, 9, 0, ADMIN_ALL, zclass5_health, 0, zclass5_speed, zclass5_gravity, zclass5_knockback)
}
