...
//new guitar_W_MODEL[64] = "models/zm/w_guitar.mdl"
...
public plugin_init()
{
	...
	cvar_dmg_guitar = register_cvar("zp_guitar_dmg", "2.2")
	...
	g_itemid_guitar = zp_arma( "Guittar", 1, 1, PRIMARIA, ADMIN_ALL, "" );
...
public plugin_precache()
{
	...
	//precache_generic("sprites/weapon_galil.txt")
...
public fw_SetModel(entity, model[])
{
	...
	if(equal(model, "models/w_galil.mdl"))
	{
		...
		if(g_has_guitar[iOwner])
		{
			...
			entity_set_model(entity, "models/w_galil.mdl")
