...
public plugin_precache()
{
	...
	zp_register_class(CLASS_HUMAN, hclass1_name, hclass1_info, hclass1_model, "default", 0, 0, ADMIN_ALL, hclass1_health, 15, hclass1_speed, hclass1_gravity, hclass1_knockback)
	zp_register_class(CLASS_HUMAN, hclass2_name, hclass2_info, hclass2_model, "default", 0, 0, ADMIN_ALL, hclass2_health, 30, hclass2_speed, hclass2_gravity, hclass1_knockback)
	zp_register_class(CLASS_HUMAN, hclass3_name, hclass3_info, hclass3_model, "default", 0, 0, ADMIN_ALL, hclass3_health, 45, hclass3_speed, hclass3_gravity, hclass1_knockback)
}