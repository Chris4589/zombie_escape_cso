...
//new tar21_W_MODEL[64] = "models/zm/w_tar21.mdl"
...
public plugin_init()
{
	...
	cvar_dmg_tar21 = register_cvar("zp_tar21_dmg", "2.7")
	...
	g_itemid_tar21 = zp_arma( "[Assault Rifle] \rTavor TAR-21", 2, 5, PRIMARIA, ADMIN_ALL, "" );
...
public fw_TraceAttack_player(victim, attacker, Float:damage, Float:direction[3], tracehandle, damage_type){
	...
	if(g_currentweapon != CSW_AUG) return HAM_IGNORED
	
	if(!g_has_tar21[attacker]) return HAM_IGNORED
	...
	xs_vec_mul_scalar(direction, 3.5, direction)
...
public fw_SetModel(entity, model[])
{
	...
	if(equal(model, "models/w_aug.mdl"))
	{
		...
		if(g_has_tar21[iOwner])
		{
			...
			entity_set_model(entity, "models/w_aug.mdl")
