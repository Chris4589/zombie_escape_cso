...
new const szKnife_v[] = "v_horn";

public plugin_init()
{
	register_plugin("Knife Horn", "1.0", "Hypnotize");
	RegisterHam(Ham_Item_Deploy, "weapon_knife", "ham_KnifeDeployPost", true);
	RegisterHam(Ham_TakeDamage, "player", "fw_TakeDamage");
	register_logevent( "event_round_start", 2, "1=Round_Start" );

	cvar_knife_dmg = register_cvar("zp_knife_horn", "100")

	g_iMaxplayers = get_maxplayers();

	g_item = zp_arma( "Horn", 4, 0, KNIFE, ADMIN_ALL, "" );
}
