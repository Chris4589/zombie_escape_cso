...
new g_Event_BALROG7, g_SmokePuff_SprId, g_RifleShell_Id, g_SprId, g_MaxPlayers, g_item
...
public fw_SetModel(entity, model[])
{
	...
	if(equal(model, BALROG7_OLDMODEL))
	{
		...
		if(Get_BitVar(g_Had_BALROG7, iOwner))
		{
			...
			engfunc(EngFunc_SetModel, entity, BALROG7_OLDMODEL)
