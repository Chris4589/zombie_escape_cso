...
public Damage_Slash(id)
{
	...
	if(Target) emit_sound(id, CHAN_WEAPON, LightSaber_Sounds[1], 1.0, ATTN_NORM, 0, PITCH_NORM)
	else if(g_WillBeHit[id] == HIT_WALL) emit_sound(id, CHAN_WEAPON, LightSaber_Sounds[9], 1.0, ATTN_NORM, 0, PITCH_NORM)
}
