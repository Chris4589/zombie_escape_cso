...
public plugin_init() 
{
	...
	g_item = zp_arma( "Balrog-3", 0, 0, PRIMARIA, ADMIN_ALL, "" );
}
...
public event_round_start() {
	for (new id; id <= 32; id++) g_Had_Balrog3[id] = false;
}
...
public Get_Balrog3(id)
{
	...
	engclient_cmd(id, weapon_balrog3);
...
public fw_PlaybackEvent(flags, invoker, eventid, Float:delay, Float:origin[3], Float:angles[3], Float:fparam1, Float:fparam2, iParam1, iParam2, bParam1, bParam2)
{
	...
	emit_sound(invoker, CHAN_WEAPON, g_Shoot_Special[invoker] == 1 ? Balrog3_Sounds[0] : Balrog3_Sounds[0], VOL_NORM, ATTN_NORM, 0, PITCH_NORM)
