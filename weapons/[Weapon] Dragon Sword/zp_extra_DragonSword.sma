...
public plugin_precache()
{
	...
	//g_DragonSword = zp_register_extra_item("Dragon Sword", 10, ZP_TEAM_HUMAN)
}
...
public Do_Slashing_Rotate(id)
{
	...
	if(Check_Attack(id, ATTACK_SLASH_ROTATE))
	{
		...
		if(g_Hit_Ing[id] == HIT_WALL) emit_sound(id, CHAN_WEAPON, DragonSword_Sound[5], 1.0, ATTN_NORM, 0, PITCH_NORM)
