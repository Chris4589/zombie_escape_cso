...
#define V_MODEL "models/zombie_plague/v_gunkata.mdl"
#define P_MODEL "models/zombie_plague/p_gunkata.mdl"
#define W_MODEL "models/zombie_plague/w_gunkata.mdl"
#define EF_HOLE "models/zombie_plague/ef_hole.mdl"
#define EF_GUNKATA_SHADOW "models/zombie_plague/ef_gunkata_man.mdl"
...
new const Sub_Resources[3][] =
{
	"sprites/weapon_gunkata.txt",
	"sprites/640hud176.spr",
	"sprites/640hud18_2.spr"
}
...
new g_SmokePuff_SprId, g_Msg_AmmoX, g_Msg_CurWeapon, g_Msg_WeaponList
public plugin_init()
{
	...
	register_clcmd("get_gunkata", "Get_Beretta")
	register_clcmd("remove_gunkata", "Remove_Beretta")
}
