...
new const GRENADE_MODEL[] = "models/w_hegrenade.mdl"
//new in_zoom[33]
new g_reload[33]
// Sprites
...
public event_round_start()
{
    ...
    {
        g_has_m32[id] = g_has_damage[id] = false;
    }
}
...
public Sprite(id,type)
{
    ...
    write_string(type?"weapon_m3":"weapon_m3")
    write_byte(5)
    write_byte(32)
    write_byte(-1)
    write_byte(-1)
...
public FireGrenade(id)
{
    ...
    velocity_by_aim( id, /*in_zoom[id]? 1400 : 1000*/1300 , velocity )
