...
#define DAMAGE_A 100 // 140 for zombie, 70 for human
#define DAMAGE_B 160 // 560 for zombie, 280 for human
...
public plugin_init()
{
	...
	register_touch(SCYTHE_CLASSNAME, "player", "fw_Scythe_Touch")
	...
	g_item = zp_arma( "Thanatos-11", 3, 2, PRIMARIA, ADMIN_ALL, "" );
	// Attach
